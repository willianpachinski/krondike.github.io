				...
				<!-----start-wrapper-dropdown-2---->
					<div id="dd" class="wrapper-dropdown-2" tabindex="1">ADMIN SETTINGS<span><img src="images/menu.png"/></span>
							<ul class="dropdown">
									...
									<li><a href="#">Edit Users<span class="icon"> </span></a></li>
									<li><a href="#">Web Staticstics<span class="icon stat"> </span></a></li>
									<li><a href="#">Upload Settings<span class="icon msg"> </span></a></li>
									<li><a href="#">Edit Slider<span class="icon signout"> </span></a></li>
							</ul>
					</div>
			</div>
